...
class PococonceptlistSpider(scrapy.spiders.Spider):
    name = "pococonceptlist"
    # allowed_domains = ['weibo.com', 'weibo.cn', 'sina.com.cn']
    # start_urls=['http://m.weibo.cn']
    # surl='http://photo.poco.cn/vision.htx&p=1&index_type=hot&tid=-1&gid=0'
    surl='http://photo.poco.cn/vision.htx&index_type=hot&tid=-1&gid=16#list'
    ...
    def see_list(self, response):
        ...
        for index1, li1 in enumerate(list3):
            ...
            # print comment_num
            # return
            item = {"data_source":self.web_domain,"cate":"观念","url":item_url,"img_main":item_img_main,"title":item_title,"author_url":author_url,"author_name":author_name,"author_uid":author_uid,"browse_num":browse_num,"vote_num":vote_num,"comment_num":comment_num}
