...
class PocomakeuplistSpider(scrapy.spiders.Spider):
    ...
    def see_list(self, response):
        ...
        for index1, li1 in enumerate(list3):
            ...
            # print comment_num
            # return
            item = {"data_source":self.web_domain,"cate":"妆型","url":item_url,"img_main":item_img_main,"title":item_title,"author_url":author_url,"author_name":author_name,"author_uid":author_uid,"browse_num":browse_num,"vote_num":vote_num,"comment_num":comment_num}
